...
export const COMPILED_RULE_JSON_SCHEMA = {
  ...
  oneOf: [
    ...
    },
    {
      type: 'object',
      additionalProperties: false,
      required: ['type', 'asset', 'unit', 'value', 'payAsset'],
      properties: {
        type: { const: 'market_buy' },
        asset: { type: 'string' },
        unit: { const: 'amount' },
        value: { type: 'number', exclusiveMinimum: 0 },
        payAsset: { type: 'string' },
    ...
    },
    {
      type: 'object',
      additionalProperties: false,
      required: ['type', 'asset', 'unit', 'value', 'payAsset', 'limitPrice'],
      properties: {
        type: { const: 'limit_buy' },
        asset: { type: 'string' },
        unit: { const: 'amount' },
        value: { type: 'number', exclusiveMinimum: 0 },
        payAsset: { type: 'string' },
