...
/**
 * Jupiter-style Send page (white, centered) — live Devnet transfers.
 */
  ...
  return (
    <div className="flex w-full flex-col items-center px-1 py-6 lg:min-h-[calc(100svh-11rem)] lg:justify-center lg:py-10">
      <section className="w-full max-w-[420px] rounded-3xl border border-border bg-card p-4 shadow-sm sm:p-5">
        {/* Send / Receive */}
        <div className="mb-4 flex gap-6 border-b border-border px-1">
        ...
        {mainTab === 'receive' ? (
          <div className="px-2 py-10 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Use Deposit to show your QR and wallet address.
            </p>
            <Button type="button" className="mt-5 rounded-xl" asChild>
              <Link to="/deposit">Open Deposit</Link>
            </Button>
          </div>
        ) : (
          <>
            <div className="grid grid-cols-2 gap-1 rounded-2xl bg-secondary p-1">
              <button
                ...
                className={cn(
                  'inline-flex cursor-pointer items-center justify-center gap-1.5 rounded-xl px-3 py-2 text-sm font-semibold',
                  subTab === 'transfer'
            ...
            {subTab === 'magic' ? (
              <div className="px-2 py-14 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Magic Link sends are not available yet. Use Transfer.
                </p>
              </div>
            ) : !owner ? (
              <div className="mt-6 rounded-2xl border border-dashed border-border bg-background px-4 py-10 text-center">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  You need a wallet to send SOL or tokens on Devnet.
                </p>
                <Button
                  type="button"
